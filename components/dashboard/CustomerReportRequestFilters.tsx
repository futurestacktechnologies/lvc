...
export default function CustomerReportRequestFilters() {
    ...
    <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
      <div className="w-full xl:max-w-sm">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search request, vehicle, lot..."
      ...
      <div className="flex flex-wrap items-center gap-3">
        <details ref={statusDropdownRef} className="relative">
          ...
          <div className="absolute right-0 z-30 mt-2 w-56 rounded-2xl border border-border bg-card p-2 shadow-xl">
            {[
              {
                value: "all" as const,
                label: "All Status",
                ...
                >
                  <span
                    className={cn(
                      ...
                      option.value === "new" && "bg-amber-50 text-amber-600",
                      option.value === "processing" && "bg-sky-50 text-sky-600",
