...
export default function AgentTableControls() {
      ...
      <div className="w-full xl:max-w-sm">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search name, mobile or promo code..."
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {hasActiveFilter && (
          <Button
            ...
            size="sm"
            onClick={clearAll}
            className="h-10 cursor-pointer rounded-2xl text-xs text-muted-foreground hover:border-destructive/40 hover:bg-destructive/10 hover:text-destructive"
          >
