...
type StatusFilter = "all" | "active" | "replaced" | "deleted";

export default function ReportTableControls() {
      ...
      <div className="w-full xl:max-w-sm">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search report, customer, request..."
                ...
                >
                  <span
                    className={cn(
                      ...
                      option.value === "deleted" && "bg-rose-50 text-rose-600",
